    ...
    <div className="flex flex-col gap-5">
      ...
      {load && car && (
        <>
          <main
            key={car?.id}
            className="relative bg-white flex flex-col rounded-b-lg shadow-xl border-2"
          >
            <Swiper
              ...
              {car?.img.map((item) => {
                return (
                  <SwiperSlide key={item.uid} className="">
                    <div
                      className="animate-pulse w-full max-h-60 md:max-h-80 lg:max-h-96 xl:max-h-[430px] 2xl:max-h-[500px] bg-gray-200"
                      style={{
                    ...
                    <img
                      src={item.url}
                      alt={item.name}
                      className="object-cover  max-h-60 md:max-h-80 lg:max-h-96 xl:max-h-[430px] 2xl:max-h-[500px]"
